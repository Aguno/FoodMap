...
class DetailsVC: UIViewController {
    //deleted price
    var passedData = (title: "Name",hours: "Morning",number: "042-1111-1111", img: #imageLiteral(resourceName: "bhc"))
    var menulist:Array<String>=["후라이드","10000","양념","12000"]
    ...
    func setupViews() {
        ...
        containerView.addSubview(lblNumber)
        lblNumber.leftAnchor.constraint(equalTo: lblTitle.leftAnchor).isActive=true
        lblNumber.topAnchor.constraint(equalTo: lblTitle.bottomAnchor).isActive=true
        lblNumber.rightAnchor.constraint(equalTo: lblTitle.rightAnchor).isActive=true
        lblNumber.heightAnchor.constraint(equalToConstant: 50).isActive=true
        lblNumber.text = passedData.number
        
        
        var textheight:CGFloat = 300
        let menucount = (menulist.count)/2
        
        for i in 0 ..< menucount{
            let textview = UITextView()
            textview.text = menulist[2*i] + "       " + menulist[2*i+1]
            
            textview.frame.size.width = 200
            textview.frame.size.height = 50
            textview.frame.origin.x = 10
            textview.frame.origin.y = textheight
    ...
    let imgView: UIImageView = {
        let v=UIImageView()
        v.image = #imageLiteral(resourceName: "bhc")
...
class DetailsVC: UIViewController {
    //deleted price
    var passedData = (title: "Name",hours: "Morning",number: "042-1111-1111", img: #imageLiteral(resourceName: "bhc"),menu: "carrots")
    ...
    func setupViews() {
        ...
        lblDescription.text = passedData.menu
